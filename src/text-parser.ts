...
export class mTextParser {
    ...
    static getString (message: string, string: string, removal: any = null) {
    ...
    static getForecastOffice (message: string) {
    ...
    static getPolygonCoordinates (message: string) {
